...
var CraftItems = []Item_craft{
	{Name: "cuirasse", Name2: "cuire", Name3: "fils", Type: "équipement", Effect: "+ 10 PV", Slot: "torse"},
	{Name: "Potion de vie", Name2: "fiole en verre", Name3: "eau de vie", Type: "consommable", Effect: "", Slot: ""},
	{Name: "Composant Inconus", Name2: "Pièce détaché", Name3: "Pièce détaché", Type: "???", Effect: "???", Slot: "???"},
}
